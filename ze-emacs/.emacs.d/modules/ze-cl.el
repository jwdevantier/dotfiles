...
(defun ze-cl/init ()
  ...
  (setq ze-slime-repl-editor-keybinds
	'(;;Documentation
  ...
  (eval-after-load "slime-repl"
    '(progn
       (message "slime repl mode loaded")
       (add-hook 'slime-repl-mode-hook
		 (lambda () (ze:bind slime-repl-mode-map
				ze-slime-repl-editor-keybinds)))))
  ...
  (eval-after-load "slime"
    '(progn
       ...
       (ze:bind slime-mode-map
		(append ze-slime-repl-editor-keybinds
